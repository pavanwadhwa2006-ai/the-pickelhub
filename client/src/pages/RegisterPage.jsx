  ...
  return (
    <PageTransition className="min-h-[calc(100vh-80px)] flex items-center justify-center py-16 px-6 sm:px-10 bg-[#181305] relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#251f10] border border-[#3b3423] p-8 sm:p-10 shadow-2xl relative animate-fade-in-up hover:border-[#5d3f3d] transition-colors">
        ...
        <div className="mb-6 p-3 bg-[#1a1508] border border-[#3b3423] flex items-center justify-between shadow-inner">
          <div className="text-[11px] font-bold tracking-wider text-[#d8cdb5] uppercase">
            Initial Rating Base
          </div>
          <div className="text-xs font-bold font-mono px-2 py-0.5 bg-[#2f2919] text-[#ffb3ad] border border-[#5d3f3d] flex items-baseline gap-1">
              ...
              <button
                ...
                className={`py-2.5 px-3 text-xs font-bold tracking-wider uppercase border text-center transition-all duration-200 cursor-pointer ${
                  role === 'PLAYER'
                    ...
                    : 'bg-[#181305] text-[#9a8e7a] border-[#3b3423] hover:text-[#ede1c9] hover:border-[#ad8885]'
                }`}
              >
                PLAYER
              </button>
